...
2. relevance为0-100的整数，表示公司与该细分赛道的关联度，低于80的不列出（宁缺毋滥但必须有充分理由排除）
...
6. 每个层级必须列出至少10个细分赛道，不允许少于10个，不允许合并赛道，必须细分到每个具体产品/元件/工艺环节
7. 每个细分赛道必须列出至少8家相关A股上市公司，不允许少于8家
8. ticker格式：A股6位数字（如000001），北交所加BJ
9. description必须包含具体数据（市场份额、营收占比、产能、毛利率等），避免空洞描述
10. 必须包含各细分赛道当前景气度（上行/平稳/下行）和驱动因素
11. 描述使用中文，专业但易懂，有具体数据支撑
12. 输出必须完整，不得因篇幅原因省略任何内容`;
